...
// Expose support vars for convenience
	...
	---------------------------------------------------------------------- */
          ...
          sortOrder = hasCompare ? function (a, b) {
            ...
            if (!aup || !bup) {
              return a === document ? -1 : b === document ? 1 : aup ? -1 : bup
                  ? 1 : sortInput ? ( indexOf(sortInput, a) - indexOf(sortInput,
                      b) ) : 0;
        ...
        Sizzle.attr = function (elem, name) {
          ...
          return val !== undefined ? val : support.attributes || !documentIsHTML
  ...
  jQuery.fn.extend({
    ...
    is: function (selector) {
      return !!winnow(
          ...
          typeof selector === "string" && rneedsContext.test(selector) ? jQuery(
              selector) : selector || [],
          false
      ).length;
    }
 ...
 */
  jQuery.event = {
          ...
          if (cur.nodeType === 1 && !( event.type === "click" && cur.disabled
            ...
            for (i = 0; i < delegateCount; i++) {
              ...
              if (matchedSelectors[sel] === undefined) {
                matchedSelectors[sel] = handleObj.needsContext ? jQuery(sel,
                    this).index(cur) > -1 : jQuery.find(sel, this, null,
                    [cur]).length;
              }
    ...
    fix: function (originalEvent) {
      return originalEvent[jQuery.expando] ? originalEvent : new jQuery.Event(
          originalEvent);
    },
...
// Generate shortcuts for custom animations
  ...
  jQuery.fx.start = function () {
    if (!timerId) {
      timerId = window.requestAnimationFrame ? window.requestAnimationFrame(raf)
