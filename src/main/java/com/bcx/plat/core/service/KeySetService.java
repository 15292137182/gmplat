...
public class KeySetService extends BaseService<KeySet> {
  ...
  public ServerResult queryProPage(String search, String rowId, int pageNum, int pageSize, List<Order> orders) {
    ...
    return new ServerResult(BaseConstants.STATUS_SUCCESS, Message.QUERY_SUCCESS,
            keySetProService.blankQuerySelectMap(search, Arrays.asList("confKey", "confValue"), condition, pageNum, pageSize, orders));
  }
