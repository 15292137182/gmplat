...
public abstract class SequenceConditionBuilder<CONDITION extends ChainCondition<CONDITION>, PARENT_NODE extends ConditionSequence, CURRENT_NODE extends ConditionSequence> implements
  ...
  public CURRENT_NODE equal(Class<? extends BeanInterface> entityClass,String alias,String attribute, Object value) {
  ...
  public CURRENT_NODE in(Class<? extends BeanInterface> entityClass,String alias,String attribute, Collection value) {
  ...
  public CURRENT_NODE between(Class<? extends BeanInterface> entityClass,String alias,String attribute, Object rangeStart, Object rangeEnd) {
    return between(getJsonAttributeColumnByAlias(entityClass, alias,attribute),rangeStart, rangeEnd);
  }
  ...
  public CURRENT_NODE like(Class<? extends BeanInterface> entityClass,String alias,String attribute, String value) {
  ...
  public CURRENT_NODE endWith(Class<? extends BeanInterface> entityClass,String alias,String attribute, String value) {
  ...
  public CURRENT_NODE startWith(Class<? extends BeanInterface> entityClass,String alias,String attribute, String value) {
  ...
  public CURRENT_NODE isNull(Class<? extends BeanInterface> entityClass,String alias,String attribute) {
  ...
  public CURRENT_NODE notEqual(Class<? extends BeanInterface> entityClass,String alias,String attribute, Object value) {
  ...
  public CURRENT_NODE notIn(Class<? extends BeanInterface> entityClass,String alias,String attribute, Collection value) {
  ...
  public CURRENT_NODE notBetween(Class<? extends BeanInterface> entityClass,String alias,String attribute, Object rangeStart, Object rangeEnd) {
    return notBetween(getJsonAttributeColumnByAlias(entityClass, alias,attribute),rangeStart, rangeEnd);
  }
  ...
  public CURRENT_NODE notBetween(String alias, Object rangeStart, Object rangeEnd) {
    return notBetween(getColumnByAlias(conditionBuilderContext.getClz(),alias),rangeStart,rangeEnd);
  }
  ...
  public CURRENT_NODE notLike(Class<? extends BeanInterface> entityClass,String alias,String attribute, String value) {
  ...
  public CURRENT_NODE notEndWith(Class<? extends BeanInterface> entityClass,String alias,String attribute, String value) {
  ...
  public CURRENT_NODE notStartWith(Class<? extends BeanInterface> entityClass,String alias,String attribute, String value) {
  ...
  private FieldSource getNormalColumnByAlias(Class<? extends BeanInterface> entityClass, String alias) {
    return moreBatis.getColumnByAlias(entityClass,alias);
  }

  private FieldSource getJsonAttributeColumnByAlias(Class<? extends BeanInterface> entityClass, String alias,String attribute) {
