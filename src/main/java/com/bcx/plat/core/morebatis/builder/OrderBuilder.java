...
public class OrderBuilder {
    ...
    public OrderBuilder(Class<? extends BaseEntity> entityClass) {
    ...
    public OrderBuilder asc(Class<? extends BaseEntity> entityClass,String alias){
    ...
    public OrderBuilder desc(Class<? extends BaseEntity> entityClass,String alias){
